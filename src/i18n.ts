...
const de = {
  ...
  shadowCenter: 'Schattenzentrum', outsideEarth: 'außerhalb der Erdoberfläche', shadowTrack: 'Sichtbarkeit & Schattenbahn', trackAvailable: 'Goldene Fläche: Sichtbarkeitsgebiet · Orange Spur: Schattenzentrum', trackUnavailable: 'Goldene Fläche: partielle Sichtbarkeit. Keine Zentrallinie, da der Kernschatten die Erde verfehlt.', simulatedTime: 'SIMULIERTE ZEIT', maximum: 'Maximum', speed: 'Geschwindigkeit',
...
const en: typeof de = {
  ...
  shadowCenter: 'Shadow centre', outsideEarth: 'outside the Earth’s surface', shadowTrack: 'Visibility & shadow path', trackAvailable: 'Golden area: visibility zone · Orange track: shadow centre', trackUnavailable: 'Golden area: partial visibility. No centre line because the umbra misses Earth.', simulatedTime: 'SIMULATED TIME', maximum: 'Maximum', speed: 'Speed', nextAtLocation: 'NEXT ECLIPSE AT YOUR LOCATION', covered: 'covered', localMaximum: 'Local maximum', sunAltitude: 'Sun altitude',
...
const es: typeof de = {
  ...
  shadowCenter: 'Centro de la sombra', outsideEarth: 'fuera de la superficie terrestre', shadowTrack: 'Visibilidad y sombra', trackAvailable: 'Área dorada: zona visible · Trazo naranja: centro de la sombra', trackUnavailable: 'Área dorada: visibilidad parcial. Sin línea central porque la umbra no alcanza la Tierra.', simulatedTime: 'HORA SIMULADA', maximum: 'Máximo', speed: 'Velocidad', nextAtLocation: 'PRÓXIMO ECLIPSE EN TU UBICACIÓN', covered: 'cubierto', localMaximum: 'Máximo local', sunAltitude: 'Altura del Sol',
...
const fr: typeof de = {
  ...
  shadowCenter: 'Centre de l’ombre', outsideEarth: 'hors de la surface terrestre', shadowTrack: 'Visibilité et ombre', trackAvailable: 'Zone dorée : visibilité · Trace orange : centre de l’ombre', trackUnavailable: 'Zone dorée : visibilité partielle. Aucune ligne centrale car l’ombre centrale manque la Terre.', simulatedTime: 'HEURE SIMULÉE', maximum: 'Maximum', speed: 'Vitesse', nextAtLocation: 'PROCHAINE ÉCLIPSE À VOTRE POSITION', covered: 'couvert', localMaximum: 'Maximum local', sunAltitude: 'Hauteur du Soleil',
...
const pt: typeof de = {
  ...
  shadowCenter: 'Centro da sombra', outsideEarth: 'fora da superfície terrestre', shadowTrack: 'Visibilidade e sombra', trackAvailable: 'Área dourada: visibilidade · Traço laranja: centro da sombra', trackUnavailable: 'Área dourada: visibilidade parcial. Sem linha central porque a umbra não atinge a Terra.', simulatedTime: 'HORA SIMULADA', maximum: 'Máximo', speed: 'Velocidade', nextAtLocation: 'PRÓXIMO ECLIPSE NO SEU LOCAL', covered: 'coberto', localMaximum: 'Máximo local', sunAltitude: 'Altura do Sol',
...
const zh: typeof de = {
  ...
  shadowCenter: '阴影中心', outsideEarth: '位于地球表面之外', shadowTrack: '可见范围与阴影路径', trackAvailable: '金色区域：可见范围 · 橙色轨迹：阴影中心', trackUnavailable: '金色区域：日偏食可见范围。本影未穿过地球，因此没有中心线。', simulatedTime: '模拟时间', maximum: '食甚', speed: '速度', nextAtLocation: '您所在地的下一次日食', covered: '被遮掩', localMaximum: '当地食甚', sunAltitude: '太阳高度',
...
const ar: typeof de = {
  ...
  shadowCenter: 'مركز الظل', outsideEarth: 'خارج سطح الأرض', shadowTrack: 'الرؤية ومسار الظل', trackAvailable: 'المنطقة الذهبية: نطاق الرؤية · المسار البرتقالي: مركز الظل', trackUnavailable: 'المنطقة الذهبية: رؤية جزئية. لا يوجد خط مركزي لأن ظل القمر المركزي لا يقطع الأرض.', simulatedTime: 'الوقت المحاكى', maximum: 'الذروة', speed: 'السرعة', nextAtLocation: 'الكسوف القادم في موقعك', covered: 'محجوب', localMaximum: 'الذروة المحلية', sunAltitude: 'ارتفاع الشمس',
...
const hi: typeof de = {
  ...
  shadowCenter: 'छाया केंद्र', outsideEarth: 'पृथ्वी की सतह से बाहर', shadowTrack: 'दृश्य क्षेत्र और छाया पथ', trackAvailable: 'सुनहरा क्षेत्र: दृश्यता · नारंगी रेखा: छाया केंद्र', trackUnavailable: 'सुनहरा क्षेत्र: आंशिक दृश्यता। गहरी छाया पृथ्वी से चूकती है, इसलिए कोई केंद्रीय रेखा नहीं है।', simulatedTime: 'अनुकृत समय', maximum: 'अधिकतम', speed: 'गति', nextAtLocation: 'आपके स्थान पर अगला ग्रहण', covered: 'ढका', localMaximum: 'स्थानीय अधिकतम', sunAltitude: 'सूर्य की ऊँचाई',
...
const ja: typeof de = {
  ...
  shadowCenter: '影の中心', outsideEarth: '地表の外側', shadowTrack: '可視範囲と影の経路', trackAvailable: '金色の範囲：可視域 · オレンジの軌跡：影の中心', trackUnavailable: '金色の範囲：部分食の可視域。本影が地球を外れるため中心線はありません。', simulatedTime: 'シミュレーション時刻', maximum: '最大食', speed: '速度', nextAtLocation: '現在地での次の日食', covered: '遮蔽', localMaximum: '現地の最大食', sunAltitude: '太陽高度',
...
const hr: typeof de = {
  ...
  shadowCenter: 'Središte sjene', outsideEarth: 'izvan Zemljine površine', shadowTrack: 'Vidljivost i putanja sjene', trackAvailable: 'Zlatno područje: vidljivost · Narančasti trag: središte sjene', trackUnavailable: 'Zlatno područje: djelomična vidljivost. Nema središnje linije jer potpuna sjena promašuje Zemlju.', simulatedTime: 'SIMULIRANO VRIJEME', maximum: 'Maksimum', speed: 'Brzina', nextAtLocation: 'SLJEDEĆA POMRČINA NA TVOJOJ LOKACIJI', covered: 'pokriveno', localMaximum: 'Lokalni maksimum', sunAltitude: 'Visina Sunca',
